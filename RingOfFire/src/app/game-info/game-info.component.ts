import { Component, Input, OnChanges, OnInit } from '@angular/core'; // Input hinzufügen
...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    },
    {
      title: 'Thumbmaster',
      description:
        'Place your thumb on the edge of the table and all have to do so, the last one drinks',
    },
    { title: 'Men', description: 'All men drink.' },
    {
      title: 'Quizmaster',
      description:
        'You are the Quizmaster until the next one is pulled and however answers any of your questions has to drink',
    },
    {
